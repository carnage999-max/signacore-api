...
class AdminAuditLog(models.Model):
    class ActionEnum(models.TextChoices):
        ...
        ORGANIZATION_MEMBER_LIST = "ORGANIZATION_MEMBER_LIST", "Organization Member List"
        ORGANIZATION_MEMBER_INVITE = "ORGANIZATION_MEMBER_INVITE", "Organization Member Invite"
        ORGANIZATION_MEMBER_REMOVE = "ORGANIZATION_MEMBER_REMOVE", "Organization Member Remove"
